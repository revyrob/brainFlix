...
function MainArticle({item}) {
    ...
    return (
        ...
        <img className='mainArticle__infoBar--icon' src={views} alt='view icon'/><p className='mainArticle__infoBar--emoji'>{item.views}</p>
        </div>
        <div className='mainArticle__infoBar__div'>
        <img className='mainArticle__infoBar--icon' src={likes} alt='view icon'/><p className='mainArticle__infoBar--emoji'> {item.likes}</p></div>
        </div>
        </div>
